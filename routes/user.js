...
const { add, getUsers, updateUsers, deleteUsers, searchUsers, sorting } = require("../controllers/usersControllers");
...
router.delete("/deleteUsers/:id", authMiddleWre, deleteUsers)
